export default function PageIntro({ title, subtitle, purpose, howToUse, example, tip }) {
  return (
    <div className="mb-10">
      ...
      <div className="bg-accent/5 dark:bg-accent-light/10 border border-accent/20 dark:border-accent-light/20 rounded-xl p-5 space-y-4">
        {purpose && (
          <div>
        ...
        {example && (
          <div className="bg-white/60 dark:bg-dark-surface/60 rounded-lg p-3 border border-border/50 dark:border-dark-border/50">
        ...
        {tip && (
          <div className="flex gap-2 items-start bg-success/10 dark:bg-success/20 rounded-lg p-3">
