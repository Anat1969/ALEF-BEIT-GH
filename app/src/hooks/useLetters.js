...
const HEBREW_LETTERS = [
  ...
  { id: 20, character: 'כ', name: 'כף', english: 'Kaf', gematria: 20 },
  { id: 30, character: 'ל', name: 'למד', english: 'Lamed', gematria: 30 },
  { id: 40, character: 'מ', name: 'מם', english: 'Mem', gematria: 40 },
  { id: 50, character: 'נ', name: 'נון', english: 'Nun', gematria: 50 },
  { id: 60, character: 'ס', name: 'סמך', english: 'Samekh', gematria: 60 },
  { id: 70, character: 'ע', name: 'עין', english: 'Ayin', gematria: 70 },
  { id: 80, character: 'פ', name: 'פה', english: 'Pe', gematria: 80 },
  { id: 90, character: 'צ', name: 'צדי', english: 'Tsade', gematria: 90 },
  { id: 100, character: 'ק', name: 'קוף', english: 'Qof', gematria: 100 },
  { id: 200, character: 'ר', name: 'ריש', english: 'Resh', gematria: 200 },
  { id: 300, character: 'ש', name: 'שין', english: 'Shin', gematria: 300 },
  { id: 400, character: 'ת', name: 'תו', english: 'Tav', gematria: 400 },
]
